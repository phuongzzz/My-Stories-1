...
Story.create!(name: "Khong Hoi Ket", description: "Hay lam!!! ^_^", user_id: 1, due_date: "30001231")
Story.create!(name: "Tu Bo Project", description: "Hay vch", user_id: 1, due_date: "30001231")
Story.create!(name: "Lam Lai Tu Dau", description: "Manh me len anh em", user_id: 1, due_date: "30001231")
